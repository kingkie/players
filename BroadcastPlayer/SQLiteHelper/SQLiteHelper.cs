...
namespace System.Data.SQLite
{
    ...
    public class SQLiteHelper
    {
        ...
        public int Delete(string tableName, Dictionary<string, object> dicCond)
        {
            StringBuilder sbData = new System.Text.StringBuilder();
        ...
        public DataTable Query(string tableName, Dictionary<string, object> dicCond, Dictionary<string, object> orderBy = null)
        {
            StringBuilder sbData = new System.Text.StringBuilder();
            ...
            if (null != orderBy) {
                sbData.Append(" ORDER BY ");
                String orderByStr = "";
                foreach (KeyValuePair<string, object> kv in orderBy)
                {
                    orderByStr += kv.Key + " "+ kv.Value + ",";
                }
                orderByStr = orderByStr.Substring(0, orderByStr.Length - 1);
                sbData.Append(orderByStr);
            }
